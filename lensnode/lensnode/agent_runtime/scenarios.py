...
SCENARIOS = {
    "knowledge_qa": {
        ...
        "prompt": (
            ...
            "with no file citation is not allowed. When evidence comes from "
            "converted document text, cite the original document path shown "
            "by the workspace tools. Never cite internal .sourcelens paths, "
            "content.md, or meta.json. Include a page or section only when "
            "the evidence provides that location explicitly; otherwise use "
            "a file-level citation and do not guess an anchor.\n\n"
