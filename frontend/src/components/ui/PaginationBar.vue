<template>
  <div
    v-if="total > 0"
    class="mt-4 flex flex-shrink-0 flex-col items-start justify-between gap-4 border-t border-gray-200 pt-4 sm:flex-row sm:items-center"
  >
    ...
    <div class="flex flex-wrap items-center gap-3">
      ...
      <span
        class="rounded-md border border-gray-200 bg-gray-50 px-3 py-1.5 text-sm font-semibold text-gray-700"
      >
        {{
