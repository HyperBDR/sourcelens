...
DATASOURCE_ARCHIVE_STORAGE_ROOT = os.getenv(
    "DATASOURCE_ARCHIVE_STORAGE_ROOT",
    "/opt/storage/private/datasource-archives",
)
...
STORAGES = {
    ...
    "datasource_archives": {
        "BACKEND": "django.core.files.storage.FileSystemStorage",
        "OPTIONS": {"location": DATASOURCE_ARCHIVE_STORAGE_ROOT},
    },
}
...
DATASOURCE_ARCHIVE_MAX_BYTES = 90 * 1024 * 1024
DATASOURCE_ARCHIVE_MAX_MEMBERS = 10_000
DATASOURCE_ARCHIVE_MAX_MEMBER_BYTES = 100 * 1024 * 1024
DATASOURCE_ARCHIVE_MAX_UNCOMPRESSED_BYTES = 1024 * 1024 * 1024
DATASOURCE_ARCHIVE_MAX_COMPRESSION_RATIO = 100
DATASOURCE_ARCHIVE_RATIO_MIN_BYTES = 1024 * 1024
DATASOURCE_ARCHIVE_MAX_DIRECTORY_BYTES = 16 * 1024 * 1024
